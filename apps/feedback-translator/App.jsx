...
function FeedbackTranslatorApp() {
  ...
  async function analyse() {
    ...
    try {
      const raw = await callClaude(userMsg, 2000, "feedback-translator");
...
Write only the reply text, no explanation.`;
    try {
      const text = await callClaudeRaw(tonePrompt, 800, "feedback-translator");
...
export default function FeedbackTranslator() {
  return (
    <AuthWrapper appId="feedback-translator">
